...
int main()
{
    ...
    unsigned int metallic = loadTexture2D("../resources/textures/titanium/Titanium-Scuffed_metallic.png");
    unsigned int roughness = loadTexture2D("../resources/textures/titanium/Titanium-Scuffed_roughness.png");
    unsigned int ao = loadTexture2D("../resources/textures/titanium/Titanium-Scuffed_ao.png");
    unsigned int normalMap = loadTexture2D("../resources/textures/titanium/Titanium-Scuffed_normal.png");

    pbrShader.use();
    glUniform1i(glGetUniformLocation(pbrShader.ID, "albedoMap"), 0);
    glUniform1i(glGetUniformLocation(pbrShader.ID, "metallicMap"), 1);
    glUniform1i(glGetUniformLocation(pbrShader.ID, "roughnessMap"), 2);
    glUniform1i(glGetUniformLocation(pbrShader.ID, "aoMap"), 3);
    glUniform1i(glGetUniformLocation(pbrShader.ID, "normalMap"), 4);
    glUniform1i(glGetUniformLocation(pbrShader.ID, "irradienceMap"), 5);
    glUniform1i(glGetUniformLocation(pbrShader.ID, "preFilterMap"), 6);
    glUniform1i(glGetUniformLocation(pbrShader.ID, "brdfLUT"), 7);
