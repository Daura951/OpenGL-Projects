...
int main()
{
    ...
    Shader quadShader("../resources/shaders/deffered_shading/quadVertex.vs", "../resources/shaders/deffered_shading/quadFragment.fs"); // for seeing individual textures of g-buffer
