...
int main()
{
    ...
    glVertexAttribDivisor(2, 1); // we tell openGL that the atribute at index 2 is going to be instanced everytime a new instance is called
    ...
    Shader shaderProgram("../resources/shaders/instancing/vertex.vs", "../resources/shaders/instancing/fragment.fs");
